...
// AddressBook.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CAddressBookApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CAddressBookApp::OnAppAbout)
...
CAddressBookApp::CAddressBookApp() noexcept
{
	...
	SetAppID(_T("AddressBook.AppID.NoVersion"));
